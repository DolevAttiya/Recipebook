...
public class MyFavourites extends JFrame {
	...
	public MyFavourites() {
		...
		this.setLocation(dim.width/2-this.getSize().width/2,dim.height/2-this.getSize().height/2);		contentPane = new JPanel();
		...
		txtpnAdvancedSearch.setBounds(292, 11, 392, 57);
