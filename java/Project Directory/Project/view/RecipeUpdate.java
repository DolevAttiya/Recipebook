...
public class RecipeUpdate extends JFrame {
	...
	public RecipeUpdate() {
		...
		textField_2.setBounds(747, 37, 270, 43);
		...
		//ALLERGIES
				...
				checkBox_7.setBounds(1079, 523, 255, 41);
				...
				checkBox_4.setBounds(1345, 308, 243, 55);
				...
				checkBox_11.setBounds(1345, 596, 265, 41);
				...
				checkBox_1.setBounds(1345, 383, 243, 41);
				...
				checkBox_9.setBounds(1079, 596, 226, 41);
				...
				checkBox.setBounds(1345, 523, 192, 41);
				...
				checkBox_10.setBounds(1345, 669, 243, 41);
				...
				textPane.setBounds(1157, 235, 340, 72);
				...
				checkBox_3.setBounds(1345, 450, 231, 41);
				...
				checkBox_2.setBounds(1079, 383, 269, 41);
				...
				checkBox_6.setBounds(1079, 450, 269, 41);
				...
				checkBox_8.setBounds(1079, 669, 226, 41);
				...
				checkBox_5.setBounds(1079, 315, 269, 41);
